...
### 5.4 Avaliação:
<p style="text-indent: 20px; text-align: justify">
Decidimos que os documentos que forem realizados por uma dupla, trio ou individualmente serão avaliados pelos os outros integrantes que não realizaram a tarefa, dessa forma, ela pode ser aprendida por todos, independente de já terem feito algo semelhante ou não. Além disso, esse método também permite que uma pessoa que não realizou determinada tarefa a avalie, dando assim uma visão diferente (não enviesada) ao documento ou atividade realizada.
</p>
...
| ![Slides_logo](../assets/logos/Slides.png) | [Google Slides](https://www.google.com/intl/pt-BR/slides/about/) | Ferramenta para criação de slides simultaneamente entre os integrantes |
...
| ![LiveShare_logo](../assets/logos/LiveShare.png) | [LiveShare](https://visualstudio.microsoft.com/pt-br/services/live-share/) | Extensão para o Visual Studio Code que permite o desenvolvimento de documentos simultâneamente entre todos os integrantes |
...
| 3.0 | 27/10/2020 | Refatoração documento de planejamento | Todos os integrantes |
